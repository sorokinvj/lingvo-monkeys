        ...
        <div className="flex flex-col gap-6 px-4 md:px-0 md:pr-4">
          <div className="flex flex-col">
            ...
            <p className="text-base md:text-lg font-sans leading-[21px] font-light">
              ...
              уровня. Так же лучше определиться, какое произношение хочешь
              развивать (например, английский бывает британским, американским,
              австралийским и тд) и подбирать аудио с нужным акцентом диктора.
              Кое-что для начала можно найти в нашей Library. Там же есть
