      ...
      <section className="mt-8 md:mt-0 w-full flex flex-col md:flex-row gap-4 md:gap-16">
        ...
        <div className="flex flex-col gap-6 md:pt-36 px-4 md:px-0 md:pr-4">
          <div className="flex flex-col">
            ...
            <p className="text-base md:text-lg font-sans leading-[21px] font-light mt-2">
              Если важно развивать именно произношение, то надо определиться с
              акцентом (например, британский или американский английский, а
              может быть, нужен австралийский?) и подбирать соответствующее
              соответствующее аудио. Кое-что для начала мы положили в{' '}
              <Link
                href="/upload"
                className="text-blue-600 font-semibold hover:underline hover:underline-offset-4"
              >
                "Ваши файлы"
              </Link>
              . Там же есть полезные ссылки для самостоятельного поиска.
            </p>
          </div>
          <div className="flex flex-col">
            <div className="flex flex-row gap-4 items-end">
              <Image
                ...
                className="w-12 md:hidden"
              />
              <h3 className="font-bold">ЗАНИМАТЬСЯ В НАУШНИКАХ (ИЛИ БЕЗ)</h3>
            </div>
            <p className="text-base md:text-lg font-sans leading-[21px] font-light">
              В наушниках меньше слышен собственный голос, и проще
              сконцентрироваться на голосе диктора. Попробуй заниматься и в
              наушниках, и без - проверь, что подходит именно тебе.
            </p>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <p className="text-base md:text-lg font-sans leading-[21px] font-light">
              ...
              В нашем плеере можно понизить скорость аудио и постепенно, когда
              читать станет слишком просто, повышать ее до оригинальной.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 md:px-0 md:mt-8 flex md:items-start md:gap-12 md:justify-between md:max-w-5xl md:mx-auto">
        <div className="flex flex-col">
          ...
          <p className="text-base md:text-lg font-sans leading-[21px] font-light">
            ...
            которой он в принципе учится разговаривать! Поэтому обезьянничай
            вволю. Старайся произносить слова так же, как диктор, копируй,
            пародируй произношение и интонации. И результат не заставит себя
            ждать!
          </p>
        </div>
        <Image
